...
public class MqttAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "mqtt", name = "persistence-type", havingValue = "memory")
    public MqttClientPersistence memoryMqttClientPersistence() {
    ...
    @Bean
    @ConditionalOnMissingBean
    @ConditionalOnProperty(prefix = "mqtt", name = "persistence-type", havingValue = "file")
    public MqttClientPersistence fileMqttClientPersistence() {
